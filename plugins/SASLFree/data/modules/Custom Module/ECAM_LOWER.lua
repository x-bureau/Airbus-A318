...
local function draw_fctl_page()--draw the flight controls page
	...
	if get(speedbrake_status, 1) == 1 then
		sasl.gl.drawText(AirbusFont, 70, 300, 1, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	elseif get(speedbrake_status, 1) == 0 then
		sasl.gl.drawText(AirbusFont, 70, 300, 1, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	else
		sasl.gl.drawText(AirbusFont, 70, 300, 1, 25, false, false, TEXT_ALIGN_LEFT, ECAM_YELLOW)
	end
	if get(speedbrake_status, 2) == 1 then
		sasl.gl.drawText(AirbusFont, 100, 310, 2, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	elseif get(speedbrake_status, 2) == 0 then
		sasl.gl.drawText(AirbusFont, 100, 310, 2, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	else
		sasl.gl.drawText(AirbusFont, 100, 310, 2, 25, false, false, TEXT_ALIGN_LEFT, ECAM_YELLOW)
	end
	if get(speedbrake_status, 3) == 1 then
		sasl.gl.drawText(AirbusFont, 130, 320, 3, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	elseif get(speedbrake_status, 3) == 0 then
		sasl.gl.drawText(AirbusFont, 130, 320, 3, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	else
		sasl.gl.drawText(AirbusFont, 130, 320, 3, 25, false, false, TEXT_ALIGN_LEFT, ECAM_YELLOW)
	end
	if get(speedbrake_status, 4) == 1 then
		sasl.gl.drawText(AirbusFont, 160, 330, 4, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	elseif get(speedbrake_status, 4) == 0 then
		sasl.gl.drawText(AirbusFont, 160, 330, 4, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	else
		sasl.gl.drawText(AirbusFont, 160, 330, 4, 25, false, false, TEXT_ALIGN_LEFT, ECAM_YELLOW)
	end
	if get(speedbrake_status, 5) == 1 then
		sasl.gl.drawText(AirbusFont, 190, 340, 5, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	elseif get(speedbrake_status, 5) == 0 then
		sasl.gl.drawText(AirbusFont, 190, 340, 5, 25, false, false, TEXT_ALIGN_LEFT, ECAM_GREEN)
	else
		sasl.gl.drawText(AirbusFont, 190, 340, 5, 25, false, false, TEXT_ALIGN_LEFT, ECAM_YELLOW)
	end
end
