...
local function draw_fuel_page()--draw the fuel page
    ...
    local function drawQuantities()
        ...
        -- left outer tank
        sasl.gl.drawText(AirbusFont, 35, 260, round(get_weight(get(fuel_current_quantity, 2)), 10), 20, false, false, TEXT_ALIGN_CENTER, ECAM_GREEN)
        -- right outer tank
        sasl.gl.drawText(AirbusFont, 485, 260, round(get_weight(get(fuel_current_quantity, 3)), 10), 20, false, false, TEXT_ALIGN_CENTER, ECAM_GREEN)
    end
