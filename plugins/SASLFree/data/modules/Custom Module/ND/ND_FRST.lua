...
position = {530, 50, 495, 500}
size = {500, 500}

-- get datarefs
heading = globalPropertyf("sim/cockpit2/gauges/indicators/heading_AHARS_deg_mag_copilot")
navid = globalProperty("sim/cockpit2/radios/indicators/nav2_nav_id")
navfreq = globalProperty("sim/cockpit/radios/nav2_freq_hz")
navCrs = globalProperty("sim/cockpit/radios/nav2_course_degm")
navhdev = globalProperty("sim/cockpit/radios/nav2_hdef_dot")
navvdev = globalProperty("sim/cockpit/radios/nav2_vdef_dot")

tas = globalPropertyf("sim/cockpit2/gauges/indicators/true_airspeed_kts_copilot")
...
frstNdMode = createGlobalPropertyi("A318/systems/ND/frst_mode", 0)
frstNdRnge = createGlobalPropertyi("A318/systems/ND/frst_rnge", 10)

frstNdCSTR = createGlobalPropertyi("A318/systems/ND/frst_cstr", 0)
frstNdWPT = createGlobalPropertyi("A318/systems/ND/frst_wpt", 0)
frstNdVORD = createGlobalPropertyi("A318/systems/ND/frst_vord", 0)
frsttNdNDB = createGlobalPropertyi("A318/systems/ND/frst_ndb", 0)
frstNdARPT = createGlobalPropertyi("A318/systems/ND/frst_arpt", 0)
frstNdTERR = createGlobalPropertyi("A318/systems/ND/frst_terr", 0)
