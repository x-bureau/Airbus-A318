...
local heading = globalProperty("A318/systems/ADIRS/2/inertial/heading")
local altitude = globalProperty("A318/systems/ADIRS/2/air/altitude")
local vertSpeed = globalProperty("sim/cockpit2/gauges/indicators/vvi_fpm_copilot")
local pitch = globalProperty("A318/systems/ADIRS/2/inertial/pitch")
local roll = globalProperty("A318/systems/ADIRS/2/inertial/roll")
